...
const SignUpForm = () => {
  ...
  const retrieveFieldTranslation = (
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <CardContent className="flex flex-col space-y-2">
          ...
          <FormField
            ...
            placeholder={retrieveFieldTranslation(
              "confirmPassword",
              "placeholder"
            )}
        ...
        <CardFooter className="flex flex-col items-center space-y-6">
          ...
          <div className="w-full px-6 flex flex-row space-x-4">
            <Button
              ...
              className="w-full bg-card rounded-xl font-extrabold  space-y-2 tracking-widest text-md  border"
            >
